...
public class FragmentSelected extends Fragment {
    ...
    public FragmentSelected(@NonNull ArrayList<ArticleInfo> dat){
        data = dat;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle saveInstanceState){
        ...
        rv = view.findViewById(R.id.selected_recyclerview);
        rv.setLayoutManager(new LinearLayoutManager(view.getContext()));
        //设置列表适配器，向适配器传递data
        ArticleInfoAdapter adapter = new ArticleInfoAdapter(data,view.getContext());
        rv.setAdapter(adapter);

        allloaded = view.findViewById(R.id.selected_all_loaded);
        refresh = view.findViewById(R.id.selected_refresh_view);
